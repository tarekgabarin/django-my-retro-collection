...
class TestsForPublicGameApi(TestCase):
    ...
    def get_games_based_on_publisher_and_console(self):
        ...
        query_params_16bit_capcom = {
            ...
            "consoles": ','.join([self.super_nes_console.name_code, self.genesis_console.name_code])
        }
        ...
        self.assertEqual(title_of_games_found_in_16bit_capcom_query, expected_titles_from_16bit_capcom_query)
    ...
    def get_games_based_on_tag_and_console(self):
        ...
        self.assertEqual(games_found_from_3d_psx_dc_query, expected_titles_from_3d_psx_dc_query)
