...
class TestsForConsoleMaker(TestCase):
    ...
    def test_get_list_gameconsole(self):
        ...
        consoles_found_in_query = self.convert_ordered_dict_to_list(response_from_get_list.data)
    ...
    def test_update_game_console(self):
        ...
        is_name_still_incorrect = GameConsole.objects.filter(name=incorrect_name).exists()
